...
export const POST = async (req: NextRequest) => {
    try {
        ...
        const { title, description, media, category, collections, tags, brand, colors, price, expense } = await req.json();

        if (!title || !description || !media || !category || !brand || !price || !expense) {
